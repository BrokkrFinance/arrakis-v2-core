...
export interface TempProxyAdminInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "changeProxyAdmin"
      | "getProxyAdmin"
...
export interface TempProxyAdmin extends BaseContract {
  connect(runner?: ContractRunner | null): TempProxyAdmin;
  waitForDeployment(): Promise<this>;

  interface: TempProxyAdminInterface;
