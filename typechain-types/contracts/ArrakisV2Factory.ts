...
export interface ArrakisV2FactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "arrakisV2Beacon"
      | "deployVault"
...
export interface ArrakisV2Factory extends BaseContract {
  connect(runner?: ContractRunner | null): ArrakisV2Factory;
  waitForDeployment(): Promise<this>;

  interface: ArrakisV2FactoryInterface;
