...
export interface IArrakisV2FactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "arrakisV2Beacon"
      | "deployVault"
  ...
  getEvent(
    nameOrSignatureOrTopic: "InitFactory" | "VaultCreated"
  ): EventFragment;
...
export interface IArrakisV2Factory extends BaseContract {
  connect(runner?: ContractRunner | null): IArrakisV2Factory;
  waitForDeployment(): Promise<this>;

  interface: IArrakisV2FactoryInterface;
