...
export interface IArrakisV2HelperInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IArrakisV2Helper extends BaseContract {
  connect(runner?: ContractRunner | null): IArrakisV2Helper;
  waitForDeployment(): Promise<this>;

  interface: IArrakisV2HelperInterface;
