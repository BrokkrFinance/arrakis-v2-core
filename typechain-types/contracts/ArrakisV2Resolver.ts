...
export interface ArrakisV2ResolverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "factory"
...
export interface ArrakisV2Resolver extends BaseContract {
  connect(runner?: ContractRunner | null): ArrakisV2Resolver;
  waitForDeployment(): Promise<this>;

  interface: ArrakisV2ResolverInterface;
